  ...
  <Layout>
    ...
    <div className={styles.container}>
      ...
      <div className={styles.container__about}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to The EasyBreezy Investor.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to The EasyBreezy Investor,
              accessible from{" "}
              <a
                href="https://financial-blog.netlify.app/"
        ...
        <ul>
          <li>By email: brie.cox@gmail.com</li>
        </ul>
      </div>
    </div>
  </Layout>
